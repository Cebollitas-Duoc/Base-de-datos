...
ALTER TABLE conector_departamento_servicio ADD CONSTRAINT conector_departamento_servicio_pk PRIMARY KEY ( id_departamento );
...
--  ERROR: PK name length exceeds maximum allowed length(30) 
ALTER TABLE conector_departamento_servicioextra ADD CONSTRAINT conector_departamento_servicioextra_pk PRIMARY KEY ( id_departamento )
;
...
ALTER TABLE servicioextra ADD CONSTRAINT servicioextra_pk PRIMARY KEY ( id_servicioextra );
...
ALTER TABLE conector_departamento_servicioextra
    ADD CONSTRAINT conector_departamento_servicioextra_servicioextra_fk FOREIGN KEY ( id_servicioextra )
        REFERENCES servicioextra ( id_servicioextra );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE conector_servicioextra_reserva
    ADD CONSTRAINT conector_servicioextra_reserva_conector_departamento_servicioextra_fk FOREIGN KEY ( id_departamento,
                                                                                                       id_servicioextra )
        REFERENCES conector_departamento_servicioextra ( id_departamento );
...
CREATE SEQUENCE servicioextra_id_servicioextra START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER servicioextra_id_servicioextra BEFORE
    INSERT ON servicioextra
    FOR EACH ROW
    WHEN ( new.id_servicioextra IS NULL )
BEGIN
    :new.id_servicioextra := servicioextra_id_servicioextra.nextval;
END;
/
